...
ActiveRecord::Schema.define(version: 20190612011336) do
  ...
  create_table "otc_markets", force: :cascade do |t|
  ...
  add_index "otc_markets", ["ask_unit", "bid_unit"], name: "index_otc_markets_on_ask_unit_and_bid_unit", unique: true, using: :btree
  add_index "otc_markets", ["ask_unit"], name: "index_otc_markets_on_ask_unit", using: :btree
  add_index "otc_markets", ["bid_unit"], name: "index_otc_markets_on_bid_unit", using: :btree
  add_index "otc_markets", ["enabled"], name: "index_otc_markets_on_enabled", using: :btree
  add_index "otc_markets", ["position"], name: "index_otc_markets_on_position", using: :btree

  create_table "otc_orders", force: :cascade do |t|
    t.string   "bid",            limit: 10,                                          null: false
    t.string   "ask",            limit: 10,                                          null: false
  ...
  add_index "otc_orders", ["offer_id"], name: "index_otc_orders_on_offer_id", using: :btree

  create_table "otc_trades", force: :cascade do |t|
