...
daemon 'amqp:otc_slave_book',
       script:   'amqp_daemon.rb',
       arguments: %w[ otc_slave_book  ]

daemon 'amqp:market_ticker',
       script:   'amqp_daemon.rb',
       arguments: %w[ market_ticker ]

daemon 'amqp:otc_market_ticker',
       script:   'amqp_daemon.rb',
       arguments: %w[ otc_market_ticker ]
...
daemon 'amqp:otc_pusher_market',
       script:   'amqp_daemon.rb',
       arguments: %w[ otc_pusher_market ]

daemon 'amqp:pusher_member',
       script:   'amqp_daemon.rb',
       arguments: %w[ pusher_member ]

daemon 'amqp:otc_pusher_member',
       script:   'amqp_daemon.rb',
       arguments: %w[ otc_pusher_member ]
...
Dir.glob "#{File.dirname(__FILE__)}/**/*.rb" do |file|
  ...
  next if %w[ amqp_daemon.rb blockchain.rb ].include?(script)
