...
Rails.application.config.assets.precompile += %w( market.css market.js html5.js Chart.min.js chart.js amc/core.js amc/charts.js amc/dark.js amc/animated.js amc.js )
